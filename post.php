...
<body>
    ...
    <div class="nav">
        ...
        <div class="right">
            <a href="blog.php" class="nav-items"><i class="fa-solid fa-pen"></i> &nbsp; Blog</a>
            <br><br>
        </div>
    </div>
    ...
    if (isset($_GET['id'])) {
        ...
        $result = mysqli_query($conn, "SELECT * FROM blogs_list where ID = " . $_GET['id'] . "");
        $row = mysqli_fetch_array($result);
        $date = urldecode($row["Date"]);
        echo "<h1 style='text-align:left;'>" . urldecode($row["Title"]) . "</h1>\n";
        echo "<h3><i class='fa fa-calendar'></i>&nbsp;&nbsp;$date</h3><br>\n";
        echo "<p>" . urldecode($row['Description']) . "</p><br><br> \n";
