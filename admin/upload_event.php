...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $xxx="";
    $blogdir = "../db_images/events/$identity";
    if (!file_exists($blogdir)) {
        mkdir("../db_images/events/" . $identity, 0777, true);
        mkdir("../db_images/events/" . $identity."/res", 0777, true);
        chmod($blogdir, 0777);
    ...
    $sql = "INSERT into events_list (`Title`,`ID`,`Date`,`Description`,`Resources`,`Resources_Index`) VALUES ('$title','$identity','$date','$content','$targetDir','$totalFiles')";
...
<body>
    ...
    <form action="upload_event.php" method="POST" enctype="multipart/form-data">
        Title: <br>
        <input maxlength="25" minlength="5" required placeholder="Title" type="text" name="title"><br><br>
        Thumbnail Image:<br>
        ...
        Content:<br>
        <textarea minlength="10" maxlength="2500" required placeholder="Content"
